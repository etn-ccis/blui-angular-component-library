    ...
    return (
        <>
            ...
            <div style={{ width: 300, height: 50, display: 'flex', flexDirection: 'row', alignItems: 'stretch' }}>
                <Spacer flex={flex1} style={{ background: Colors.blue[300] }}>1</Spacer>
                <Spacer flex={flex2} style={{ background: Colors.yellow[300] }}>2</Spacer>
                <Spacer flex={flex3} style={{ background: Colors.red[300] }}>3</Spacer>
            </div>
    ...
    return (
        <>
            ...
            <div style={{ width: 300, height: 50, display: 'inline' }}>
                <Spacer width={size1} style={{ background: Colors.blue[300], display: 'inline-block' }}>1</Spacer>
                <Spacer width={size2} style={{ background: Colors.yellow[300], display: 'inline-block' }}>2</Spacer>
                <Spacer width={size3} style={{ background: Colors.red[300], display: 'inline-block' }}>3</Spacer>
            </div>
            <Typography style={{marginTop: 20}}>Vertical</Typography>
            <div style={{ width: 300, height: 300 }}>
                <Spacer height={size1} style={{ background: Colors.blue[300] }}>1</Spacer>
                <Spacer height={size2} style={{ background: Colors.yellow[300] }}>2</Spacer>
                <Spacer height={size3} style={{ background: Colors.red[300] }}>3</Spacer>
            </div>
        </>
    )
});