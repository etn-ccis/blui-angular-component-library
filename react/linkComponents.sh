...
rm -rf "./component-demo/demo/node_modules/@pxblue/react-components"
mkdir "./component-demo/demo/node_modules/@pxblue/react-components"
...
cp -r ./components/package.json ./component-demo/demo/node_modules/@pxblue/react-components/package.json
cp -r ./core ./component-demo/demo/node_modules/@pxblue/react-components/core
...
if [ ! -f ./component-demo/demo/node_modules/@pxblue/react-components/package.json ]; then echo -e "${BRED}Not Linked${NC}" && exit 1; fi
if [ ! -f ./component-demo/storybook/node_modules/@pxblue/react-components/package.json ]; then echo -e "${BRED}Not Linked${NC}" && exit 1; fi
if [ ! -s ./component-demo/demo/node_modules/@pxblue/react-components/core ];
    then
        if [ ! -f ./component-demo/demo/node_modules/@pxblue/react-components/core/index.js ];
