    ...
    icon(): JSX.Element {
        ...
        if (icon && avatar) {
            return (
                <ListItemAvatar>
                    <Avatar
                        // TODO: How do we get this to work with our current theme palette?  Should we add a type to the PXB Colors so we know below is a valid value.
