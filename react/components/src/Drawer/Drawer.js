...
class SideNav extends React.Component {
    ...
    getSubHeader() {
        ...
        return <>{subheader && React.cloneElement(subheader, { open: this.isDrawerOpen() })}</>;
    }
    ...
    getFooter() {
        ...
        return <>{footer && React.cloneElement(footer, { open: this.isDrawerOpen() })}</>;
    }
    ...
    getMobileNavigationMenu() {
        ...
        return (
            ...
            >
                <div className={classes.smooth + ' ' + classes.content} style={{ width: theme.spacing(45) }}>
