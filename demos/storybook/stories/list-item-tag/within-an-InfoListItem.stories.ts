        ...
        <div style="background-color:white;">
            <pxb-info-list-item title="Info List Item" subtitle="with a ListItemTag component to the right">
                ...
                <div right-component style="width: 180px; display: flex; justify-content: space-between;">
                    <pxb-list-item-tag label="Build Passing" [backgroundColor]="colors.green[500]"></pxb-list-item-tag>
                    <pxb-list-item-tag label="5 Bugs" [backgroundColor]="colors.yellow[500]"></pxb-list-item-tag>
                </div>
            </pxb-info-list-item>
        </div>
      `,
