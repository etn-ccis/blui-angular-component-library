...
export const WITHIN_TOOLBAR = `<div style="width: 300px">
    <ng-template #avatar>
        ...
        <blui-user-menu menuTitle="Jane Doe" menuSubtitle="Account Manager" [(open)]="open">
            ...
            <div blui-menu-body>
                 <mat-nav-list [style.paddingTop.px]="0">
                    <blui-info-list-item *ngFor="let item of items" 
                        [dense]="true" (click)="open=false">
    ...
    <div style="padding: 16px; height: 60px; background: white" class="mat-body-1">
